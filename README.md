# kkFileView
### 20251218@ZHANGCHAOO 升级 PDF.js 组件最新版到 V5.4.449，增加高亮效果，默认 xlsx 默认使用 PDF 模式预览，以便于进行标注后留存文件。
### 20251011@ZHANGCHAO 已修改了部分源码解决了部分BUG。官方Docker镜像发布到中央仓库的比较老旧，只有4.1.0版本，最新版本镜像需自行构建。下方文档里已经写了如何构建基础镜像和应用镜像！
文档在线预览项目解决方案。万能的文件预览开源项目，基本支持主流文档格式预览，如：
...
地址：[https://github.com/yak33/kkFileView](https://github.com/yak33/kkFileView)

### 项目文档（Project documentation）
1. 详细使用文档：https://kkview.cn/zh-cn/docs/home.html
2. 部署运维手册：[点击查看](./部署运维手册.md)

> **注意：** 官方 Docker 镜像比较老旧，目前只更新到 4.1.0 版本。如果需要使用最新版本4.4.0，建议自己构建镜像部署，详细操作步骤请参考[部署运维手册](./部署运维手册.md)。
...
1. 第一步：pull 项目 https://github.com/yak33/kkFileView.git

3. 第二步：运行 ServerMain 的 main 方法，服务启动后，访问 http://localhost:8012/
会看到如下界面，代表服务启动成功
   
![首页](./doc/img/preview/preview-home.png)
