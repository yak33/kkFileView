...
URL：[https://kkview.cn/zh-cn/docs/home.html](https://kkview.cn/zh-cn/docs/home.html)

Documentation：[View Deployment & Operations Manual](./部署运维手册.md)

> **Note:** The official Docker image is outdated and only updated to version 4.1.0. If you need the latest version, it is recommended to build the image yourself. Please refer to the [Deployment & Operations Manual](./部署运维手册.md) for detailed steps.
...
1. First step：`git pull https://github.com/yak33/kkFileView.git`
...
15. Official docker image repository build: [https://hub.docker.com/r/keking/kkfileview](https://hub.docker.com/r/keking/kkfileview)
